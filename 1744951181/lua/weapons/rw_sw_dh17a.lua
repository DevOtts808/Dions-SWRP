...
SWEP.PrintName						= "DH-17a"
SWEP.Type							= "Rebel Blaster Pistol"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.VMPos = Vector(1.96, -6.814, -02.45)
...
SWEP.IronSightsPos = Vector(-5.7, -4.2, 3.8)
...
SWEP.VElements = {
	["dl44"] = { type = "Model", model = "models/sw_battlefront/weapons/dh17_noscope.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-0.2, -0.5, -3), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["dl44"] = { type = "Model", model = "models/sw_battlefront/weapons/dh17_noscope.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5, 1, 1.4), angle = Angle(-3, -5, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
