...
SWEP.IronRecoilMultiplier			= 0.50
...
SWEP.VMPos = Vector(2.01, -8.2, -0.02)
...
SWEP.IronSightsPos = Vector(-4.45, -5, 2)
...
SWEP.VElements = {
	["a280"] = { type = "Model", model = "models/sw_battlefront/weapons/a280_rifle.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-0.5, -5.5, -0.65), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 0, [2] = 0, [3] = 1} },
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_e11_reference001", rel = "a280", pos = Vector(4.45, 0, 5.905), angle = Angle(0, 180, 0), size = Vector(0.29, 0.29, 0.29), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}	

SWEP.WElements = {
	["a280"] = { type = "Model", model = "models/sw_battlefront/weapons/a280_rifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2, 0.4, 0.5), angle = Angle(-13, 0, 180), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 0, [2] = 0, [3] = 1} },
}
