...
cfg:AddStaff("owner", "Owner", Color(255, 0, 0), 999)
cfg:AddStaff("superadmin", "Super Admin", Color(255, 0, 0))
cfg:AddStaff("admin", "Admin", XeninUI.Theme.Blue)
...
cfg:AddURL({
	...
	tabName = "Use this link:",
	url = "https://discord.gg/pG6UZRr7ar",
	icon = "vHESvbx"
})
cfg:AddWebsite({
	name = "Steam Group",
