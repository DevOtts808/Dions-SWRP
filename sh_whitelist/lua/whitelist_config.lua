...
-- If the player is whitelisted to one of the jobs below,
-- they will get automatically assigned to the FIRST job found when connecting.
-- Empty the table to not use this feature.
SH_WHITELIST.AutoAssignJobs = {
	"Clone Cadet", -- If the player is whitelisted to this job, they will spawn with it. If not, c
}
...
-- More information here: https://www.gmodstore.com/community/threads/4465-libgmodstore/post-31807#post-3180776561198183613561
...
SH_WHITELIST.WhitelistedJobs = {
	["Clone Trooper"] = true,
	["Clone Heavy"] = true,
	["Clone Sharpshooter"] = true,
	["Drill Sergeant"] = true,
	
	["501st Enlisted"] = true,
	["501st Medic"] = true,
	["501st Engineer"] = true,
	["501st Heavy NCO"] = true,
	["501st Heavy Officer"] = true,
	["501st Jet NCO"] = true,
	["501st Jet Officer"] = true,
	["501st Major Jesse"] = true,
	["501st EXO Appo"] = true,
	["501st Commander Rex"] = true,

	
	["212th Enlisted"] = true,
	["212th Medic"] = true,
	["212th Ghost NCO"] = true,
	["212th Ghost Officer"] = true,
	["212th Ghost Major"] = true,
	["212th Airbourne NCO"] = true,
	["212th Airbourne Officer"] = true,
	["212th Airbourne Major"] = true,
	["212th EXO Waxer"] = true,
	["212th Commander Cody"] = true,
	...
	["CIS B2 Droid"] = true,
	["BX Commando"] = true,
	["BX Commando Stalker"] = true,
	["BX Commando Heavy"] = true,
	["CIS Tactical droid"] = true,
