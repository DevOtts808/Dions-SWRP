-- IDEA: Presets and 76561198183613561
	...
	_SH_WHITELIST = wnd
		...
		jobswl:Dock(FILL)
			...
			local function AddJob(tx, id, color)
				...
				-- Checked?
				local whitelisted = (selusg and self.Whitelisted.usergroups[selusg] or self.Whitelisted.players[selid]) or {} /* 76561198183613557 */
